...
Provide a runnable empty Spring Boot service with multi-module Gradle layout, profile-aware H2 datasources, Flyway-managed schema, Actuator health, scheduling/async enablement, and ArchUnit-enforced module boundaries. This is the scaffolding every later capability (F01 onward) depends on.
